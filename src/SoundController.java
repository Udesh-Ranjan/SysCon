...
//                    out.println("token : "+token);
    ...
    public static void muteVolume() {
        ...
        if (os.equalsIgnoreCase("Linux")) {
            ...
            Runtime runtime = Runtime.getRuntime();
            try {
                Process pro = runtime.exec("nircmd/nircmd mutesysvolume 1");
                BufferedReader stdIn = new BufferedReader(new InputStreamReader(pro.getInputStream()));
                BufferedReader stdErr = new BufferedReader(new InputStreamReader(pro.getErrorStream()));
                String str = null;
                boolean flag = true;
                ...
                out.println(exception);
                out.println("Unable to mute using nircmd");
            }
        }
    }
    ...
    public static void unmuteVolume() {
        ...
        if (os.equalsIgnoreCase("Linux")) {
            ...
            Runtime runtime = Runtime.getRuntime();
            try {
                Process pro = runtime.exec("nircmd/nircmd mutesysvolume 0");
                BufferedReader stdIn = new BufferedReader(new InputStreamReader(pro.getInputStream()));
                BufferedReader stdErr = new BufferedReader(new InputStreamReader(pro.getErrorStream()));
                String str = null;
                boolean flag = true;
                ...
                out.println(exception);
                out.println("Unable to unmute using nircmd");
            }
        }
    }
}
